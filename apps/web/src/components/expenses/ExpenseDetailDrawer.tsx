  ...
  return (
    <Fragment>
      <Drawer
        ...
        destroyOnClose
        extra={
          !isLoading && expense && onRequestEdit && !expenseLockedForEditDelete(expense.status) ? (
            <Button
              type="primary"
              onClick={() => {
          ...
          <Tabs
            items={[
              ...
              },
              {
                ...
                label: 'Bình luận',
                children: expenseId ? (
                  <CommentSection groupId={groupId} expenseId={expenseId} />
                ) : null,
              },
              {
                key: 'audit',
                ...
                children: auditLoading ? (
                  ...
                  <ul className="list-none space-y-2 p-0">
                    {audit.map((a) => (
                      <li
                        key={a.id}
                        className="rounded-lg border border-stone-100 bg-white p-3 text-sm shadow-sm"
                      >
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <Tag
                            className="!m-0"
                            color={a.source === 'group_activity' ? 'blue' : 'default'}
                          >
