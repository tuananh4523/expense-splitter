...
export const APP_NAME =
  typeof rawName === 'string' && rawName.trim() !== '' ? rawName.trim() : 'Swantech chi tiêu'
...
const ghId = webPkg.authorSocial?.github?.trim() || 'dovancuongadhp'
const liId = webPkg.authorSocial?.linkedin?.trim() || 'dovancuongadhp'
